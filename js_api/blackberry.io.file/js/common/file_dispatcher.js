...
(function() {
    ...
    FileDispatcher.prototype.copy = function(path, targetPath) {
        var result = makeCall("copy", {
            "path": path,
            "targetPath": targetPath
        });
        
        if (isDefined(result.code)) {
            if (result.code != WEBWORKS_RETURN_VALUE_SUCCESS) {
    ...
    FileDispatcher.prototype.readFile = function(path, callbackId, async) {
        var result = makeCall("readFile", {
            "path": path,
            "cb": callbackId,
            "async": async
        });
    ...
    FileDispatcher.prototype.open = function(path) {
        var result = makeCall("open", {
            "path": path
        });
        
        if (isDefined(result.code)) {
            return result.code == WEBWORKS_RETURN_VALUE_SUCCESS;
        }
    ...
    FileDispatcher.prototype.getFileProperties = function(path) {
        ...
        if (isDefined(result.data)) {
            ...
            props.__defineGetter__("dateCreated", function() {
                return result.data.dateCreated;
            });
            props.__defineGetter__("dateModified", function() {
                return result.data.dateModified;
            });
            props.__defineGetter__("directory", function() {
                return result.data.directory;
            });
            props.__defineGetter__("fileExtension", function() {
                return result.data.fileExtension;
            });
            props.__defineGetter__("isHidden", function() {
                return result.data.isHidden;
            });
            props.__defineGetter__("size", function() {
