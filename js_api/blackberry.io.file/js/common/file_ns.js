...
(function () {
	...
	function File(disp) {
		...
		this.constructor.prototype.readFile = function(path, onFileOpened) {
								if(typeof(onFileOpened) != "function") throw new Error("Required argument missing: onFileOpened callback function.");
									
								var callbackId = blackberry.events.registerEventHandler("onFileReadComplete", onFileOpened);
								
								disp.readFile(path, callbackId);
							};
		 ...
		 */
		this.constructor.prototype.__defineGetter__("sharedFolderPath", function() { return disp.sharedFolderPath; });		
	}
