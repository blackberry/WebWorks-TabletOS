    ...
    function generateTestCaseCallback(Y) {
        ...
        testCases[0] = new Y.Test.Case({
			...
			*/
			...
			"Manual Test - should invoke Browser": function() {
			...
			//Invoke Basic Camera
			"Manual Test - should invoke Camera": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			//Invoke Basic Music
			"Manual Test - should invoke Music": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			//Invoke Basic Photos
			"Manual Test - should invoke Photos": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			//Invoke Basic Videos
			"Manual Test - should invoke Videos": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"Manual Test - should invoke AppWorld": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			//Invoke Basic Maps
			"Manual Test - should invoke Maps": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			//Invoke Basic Update
			"Manual Test - should invoke Update": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"Manual Test - should invoke Browser when parameter is a null": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"Manual Test - should invoke Music when parameter is a null": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"Manual Test - should invoke Camera when parameter is a null": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"Manual Test - should invoke Maps when parameter is a null": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"Manual Test - should invoke VIDEOS when parameter is a null": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"Manual Test - should invoke APPWORLD when parameter is a null": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"Manual Test - should invoke UPDATE when parameter is a null": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"Manual Test - should invoke Photo when parameter is a null": function() {
				framework.test = this; //so pass() and fail() can access this test
