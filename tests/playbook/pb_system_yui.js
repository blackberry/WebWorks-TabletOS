(function(){
	...
	function generateTestCaseCallback(Y){
		...
		testCases[0] = new Y.Test.Case({
			...
			"blackberry.system.hasCapability('input.touch') should return false" : function() {
				Assert.areSame(blackberry.system.hasCapability("input.touch"), false);
			},
			...
			"blackberry.system.model should return the device model" : function() {
				framework.test = this; 
				framework.setInstructions ("Device model is being reported as '" + blackberry.system.model + "', indicate pass/fail status now");
			...
			"blackberry.system.event.deviceBatteryLevelChange should return a level change event": function () {
			...
			"blackberry.system.event.deviceBatteryStateChange should return a level change event": function () {
				framework.test = this; //so pass() and fail() can access this test
